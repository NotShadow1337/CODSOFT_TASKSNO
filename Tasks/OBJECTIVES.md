...
Defines the conditions where the user wins.
...
Create a simple Contact Book application to store, search, update, and delete contact information.
...
Creates an empty list to store contact details.
...
Stores a contact's name and phone number.
...
Checks if the entered name matches any saved contact.
